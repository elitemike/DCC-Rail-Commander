...
/**
 * Parse myStartup.h's AUTOSTART section to extract track manager options.
...
/**
 * Generate myStartup.h's TrackManager AUTOSTART block for EX-CommandStation
 */
export function generateMyAutomation(opts: MyAutomationOptions): string {
    const lines: string[] = [
        '// myStartup.h - Generated by DCC-Rail-Commander',
        '',
    ]
