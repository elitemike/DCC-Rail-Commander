...
describe('buildFileChangeSet', () => {
    ...
    it('treats a file whose generator header timestamp is the only difference as "unchanged"', async () => {
        ...
        const before = [
            '// =============================================================================',
            '// DCC-Rail-Commander v0.1.0',
            '// This file (myRoster.h) is managed by DCC-Rail-Commander — manual edits are preserved',
    ...
    it('leaves a header-only version bump visible in the diff pane as an empty (unhighlighted) change', async () => {
        ...
        const after = before.replace('DCC-Rail-Commander v0.1.0', 'DCC-Rail-Commander v0.2.0')
